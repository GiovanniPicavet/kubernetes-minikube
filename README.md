...
```
docker tag  68f9db9a3b8d giovannipcv/myservice:latest
```
...
```
docker push giovannipcv/myservice:latest
```
...
```
```
kubectl create deployment myservice --image=giovannipcv/myservice:latest
```
...
```
kubectl exec -it myservice-746766f779-77zgz -- /bin/bash
```
